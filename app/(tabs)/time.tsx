...
import { Clock, Play, Pause, RotateCcw, Timer } from 'lucide-react-native';
    ...
    <SafeAreaView className="flex-1 bg-gray-50">
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        <View className="pt-4 pb-6 px-4">
          ...
          <Text className="text-gray-600">Current time and productivity timers</Text>
        </View>
        ...
        <View className="bg-white rounded-3xl shadow-lg p-6 mx-4 mb-6">
          <Text className="text-xl font-bold text-gray-800 mb-4">Focus Timer</Text>
          ...
          {/* Timer Presets */}
          <Text className="text-lg font-semibold text-gray-800 mb-3">Quick Start</Text>
            ...
            {timerPresets.map((minutes) => (
              <TouchableOpacity
                ...
                className={`bg-gray-50 rounded-2xl px-4 py-3 mb-2 ${
                  selectedTimer === minutes ? 'bg-blue-50 border border-blue-200' : ''
                }`}
                style={{ width: '30%' }}
              >
                <Text className={`text-center font-semibold ${
                  selectedTimer === minutes ? 'text-blue-600' : 'text-gray-700'
                }`}>
                  {minutes}m
                </Text>
              </TouchableOpacity>
        ...
        {/* Time Zones */}
        <View className="bg-white rounded-3xl shadow-lg p-6 mx-4 mb-6">
          <Text className="text-xl font-bold text-gray-800 mb-4">World Clock</Text>
