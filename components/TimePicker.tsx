    ...
    <View className="bg-white rounded-3xl shadow-lg p-6 mx-4 mb-6">
      ...
      <View className="mt-6 px-4">
        ...
        <View className="h-2 bg-gray-100 rounded-full relative">
          <View className="absolute left-0 top-0 h-2 bg-blue-500 rounded-full" style={{ width: '40%' }} />
          <View className="absolute w-6 h-6 bg-blue-500 rounded-full -top-2 shadow-md" style={{ left: '35%' }} />
        </View>
      </View>
    </View>
  );
