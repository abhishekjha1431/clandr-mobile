        ...
        <View>
          ...
          {days.map((day, dayIndex) => (
            <View key={day} className="flex-row items-center mb-2">
              <View className="w-12">
                <Text className="text-gray-600 text-sm font-semibold">{dayLabels[dayIndex]}</Text>
              </View>
              {times.map((time) => {
      ...
      <View className="mt-6 pt-4 border-t border-gray-100">
        ...
        <View className="flex-row space-x-3">
          <TouchableOpacity className="bg-green-50 rounded-xl px-4 py-3 flex-1 items-center">
            <Text className="text-green-600 font-semibold text-sm">Add Available Slot</Text>
          </TouchableOpacity>
          <TouchableOpacity className="bg-gray-50 rounded-xl px-4 py-3 flex-1 items-center">
            <Text className="text-gray-600 font-semibold text-sm">Block Time</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
