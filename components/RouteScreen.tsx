...
import { ArrowLeft, MapPin, Clock, Users, Car } from 'lucide-react-native';
...
export default function RouteScreen({ event, onBack }: RouteScreenProps) {
  ...
  const participantColors = ['bg-blue-500', 'bg-green-500', 'bg-purple-500', 'bg-pink-500'];
      ...
      <View className="p-4">
        ...
        <View className="bg-blue-500 rounded-3xl p-8 mb-6 shadow-lg">
          <View className="items-center">
            <Text className="text-white text-sm font-medium mb-2">November 2024</Text>
            <Text className="text-white text-5xl font-bold mb-4">{event.time}</Text>
          ...
          <View className="space-y-4">
            ...
            <View className="flex-row items-center">
              ...
              <View className="flex-1">
                <Text className="text-lg font-bold text-gray-800">{event.from}</Text>
                <Text className="text-gray-500">It is a long established fact that</Text>
              </View>
            ...
            <View className="flex-row items-center">
              ...
              <View className="flex-1">
                <Text className="text-lg font-bold text-gray-800">{event.to}</Text>
        ...
        <View className="bg-white rounded-3xl p-6 mb-6 shadow-lg">
          <View className="h-48 bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl items-center justify-center relative overflow-hidden">
            ...
            <View className="bg-white rounded-2xl px-4 py-2 shadow-md">
              <Text className="text-gray-600 text-sm font-medium">{event.duration}</Text>
            </View>
          </View>
        </View>
        ...
        <View className="bg-white rounded-3xl p-6 shadow-lg">
          <Text className="text-lg font-bold text-gray-800 mb-4">Transport Options</Text>
          <View className="flex-row justify-around">
            <TouchableOpacity className="items-center p-4 rounded-2xl bg-blue-50">
              <Car size={24} color="#3B82F6" />
              <Text className="text-blue-600 text-sm font-medium mt-2">Car</Text>
            </TouchableOpacity>
            <TouchableOpacity className="items-center p-4 rounded-2xl bg-gray-50">
              <Users size={24} color="#6B7280" />
              <Text className="text-gray-600 text-sm font-medium mt-2">Walk</Text>
            </TouchableOpacity>
            <TouchableOpacity className="items-center p-4 rounded-2xl bg-gray-50">
              <Clock size={24} color="#6B7280" />
              <Text className="text-gray-600 text-sm font-medium mt-2">More</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
